...
[![Version](https://img.shields.io/badge/version-1.0.8-blue.svg?style=flat-square)](https://github.com/dezaetterg/echo-search/releases)
...
> **Рекомендуемый способ:** Настоятельно рекомендуется использовать **Универсальный установщик** (`install.sh`). Он автоматически определяет дистрибутив, ставит все необходимые системные зависимости и настраивает интеграцию с системой под ключ.
...
wget -O /tmp/echo-search.deb https://github.com/dezaetterg/echo-search/releases/latest/download/echo-search_1.0.8_all.deb

...
[![Version](https://img.shields.io/badge/version-1.0.4-blue.svg?style=flat-square)](https://github.com/dezaetterg/echo-search/releases)
...
```bash
sudo apt install ./echo-search_1.0.4_all.deb
```
...
cd echo-search
./build_rpm.sh
sudo dnf install ./echo-search-1.0.4-1.noarch.rpm
```
